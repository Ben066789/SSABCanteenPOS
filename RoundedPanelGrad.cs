...
{
    [ToolboxItem(true)]
    public class RoundedPanelGrad : Panel
    {
        [Category("Appearance")]
        ...
        [Category("Appearance")]
        [Description("The first color of the gradient background.")]
        public Color GradientColor1 { get; set; } = Color.White;

        [Category("Appearance")]
        [Description("The second color of the gradient background.")]
        public Color GradientColor2 { get; set; } = Color.LightBlue;

        [Category("Appearance")]
        [Description("The angle of the gradient background.")]
